...
- **Task Completion**: Mark tasks as completed with a checkbox, applying a visual strikethrough style.
- **Delete Tasks**: Remove tasks permanently from the list.
- **Data Persistence**: Uses `localStorage` to save tasks, so data is not lost on page reload.
